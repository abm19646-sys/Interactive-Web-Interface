...
Students also learn to use conditional statements such as if, else, and switch, along with looping structures like for, while, and do-while to control program flow
and execute repetitive tasks efficiently.
The unit further covers user-defined functions, which help in writing reusable and organized code.
Concepts of variable declaration using var, let, and const are demonstrated to explain scope and best coding practices in JavaScript.
